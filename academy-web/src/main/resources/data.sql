...
INSERT INTO public."user" (id, username, password, first_name, last_name, email) VALUES (2, 'user', '$2a$10$32.rsTWsrcbHIbZZIGtvJOKQPNO.Vzzm9Wu0I13T7yG58ooTd76JO', 'user', 'user', 'user@autorun.solutions');
...
ALTER SEQUENCE public.system_id_seq RESTART WITH 4;
...
ALTER SEQUENCE public.task_id_seq RESTART WITH 4;
